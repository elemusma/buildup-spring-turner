...
echo '<a href="https://buildupuniversity.com/" target="_blank" rel="noopener noreferrer" class="d-block position-lg-absolute d-flex align-items-center" style="bottom:25px;padding-top:45px;text-decoration:none;">';
...
echo '<img src="https://buildupuniversity.com/wp-content/uploads/2024/02/Developed-by-BuildUp.png" style="width:150px;" class="h-auto ml-2" alt="">';
echo '</a>';
